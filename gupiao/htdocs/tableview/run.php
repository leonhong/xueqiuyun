    ...
    foreach($list as $k=>$v){
        ...
        //echo "</br>";
            ...
            if ($sunyi['bizhong'] == '港币') {
                ...
                if ($huilv) {
                    ...
                    $meiguguxi = $sunyi['meiguguxi']*$huilv['value'];
                } else {
                    $zhanying = $sunyi['gudongyingzhanyingli']; //当前股东占盈利
                    $guxi = $sunyi['guxi'];
                    $meiguguxi = $sunyi['meiguguxi']*$huilv['value'];
        ...
        //echo "</br>";
            ...
            if ($lastyearsunyi['bizhong' == '港币']) {
                ...
                $lastyear_meiguguxi = $lastyearsunyi['meiguguxi'];
            } else {
                ...
                if ($huilv) {
                    ...
                    $lastyear_meiguguxi = $lastyearsunyi['meiguguxi']*$huilv['value'];
                } else {
                    $lastyear = $lastyearsunyi['gudongyingzhanyingli'];
                    $lastyear_guxi = $lastyearsunyi['guxi'];
                    $lastyear_meiguguxi = $lastyearsunyi['meiguguxi'];
            ...
            if ($lastsunyi['bizhong'] == '港币') {
                ...
                $last_meiguguxi = $lastsunyi['meiguguxi'];
            }else{
                $sql = "select * from huilv where Fbizhong='{$lastyearsunyi['bizhong']}' and Tbizhong='港币'";
                $huilv = $db->selectOne($sql);
                if ($huilv) {
                    ...
                    $last_meiguguxi = $lastsunyi['meiguguxi']*$huilv['value'];
                }else{
                    $last = $lastsunyi['gudongyingzhanyingli'];
                    $last_guxi = $lastsunyi['guxi'];
                    $last_meiguguxi = $lastsunyi['meiguguxi'];
               ...
               //判断今年是否有财报
                ...
                if(empty($guxi)){
                 ...
                 $dangqianguxi = ($guxi+($lastyear_guxi-$last_guxi))*1000000; //当前股息
                 if($dangqianguxi < 1){
                       $dangqianguxi = ($meiguguxi+($lastyear_meiguguxi-$last_meiguguxi))*$v['guben']/100;
                       if($dangqianguxi > 0){
                           echo "股息hello:".$v['code']."==".$dangqianguxi."</br>";
				echo "\n";
                       }
		...
		#echo '111xxxxxxxxxxxxxxxx:'.$sql;
                ...
                if($fuzhaixinxi['bizhong']=='港币'){
                    ...
                    $shaoshugudongquanyi_jinjin = $fuzhaixinxi['shaoshugudongquanyi']*1000000;
                }else{
                    ...
                    $shaoshugudongquanyi_jinjin = $fuzhaixinxi['liudongzichan']*1000000*$huilv['value'];
                }
		...
		#echo 'liudongzichan='.$liudongzichan.' zongfuzhai='.$zongfuzhai."\n";
                if($is_bank>0){
                    $data['jinjin'] = '0';
                }else{
                    if($zongzichan != '0') {
                ...
                $data['52zuidi'] = (($v['zuidi52']-$v['gujia'])/$v['gujia'])<=0.01&&(($v['zuidi52']-$v['gujia'])/$v['gujia'])>=-0.01?1:0;
