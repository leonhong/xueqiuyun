...
#     $socket = new TSocket($storm_conf['host'], $storm_conf['port']);
	...
	$tmp_cluster['id'] = $val->name;
#	$tmp_cluster['address']=$address.":8360";
	$tmp_cluster['address']="storm01v.sys.zwt.qihoo.net:8361/?nimbus=".$address;
	...
	$tmp_cluster['net'] = $val->attr["net_type"]." "."waiwang=" . $val->attr["waiwang"];
	    ...
	    $tmp_topology['name']=$tpval->name;
	  #  $tmp_topology['topology_address']= $address . ":8360/topology/" . $tpval->id;
	    $tmp_topology['topology_address']= "storm01v.sys.zwt.qihoo.net:8361/topology/".$tpval->id."?nimbus=".$address;
