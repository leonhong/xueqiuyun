...
include_once $GLOBALS['THRIFT_ROOT'].'/packages/clusters_overview/mapred_service_types.php';
...
interface MapredServiceIf {
  ...
  public function getYarnInfo();
  public function getYarnNodes();
}
...
class MapredServiceClient implements MapredServiceIf {
  ...
  public function getYarnInfo()
  {
    $this->send_getYarnInfo();
    return $this->recv_getYarnInfo();
  }

  public function send_getYarnInfo()
  {
    $args = new MapredService_getYarnInfo_args();
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'getYarnInfo', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('getYarnInfo', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_getYarnInfo()
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'MapredService_getYarnInfo_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new MapredService_getYarnInfo_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new Exception("getYarnInfo failed: unknown result");
  }

  public function getYarnNodes()
  {
    $this->send_getYarnNodes();
    return $this->recv_getYarnNodes();
  }

  public function send_getYarnNodes()
  {
    $args = new MapredService_getYarnNodes_args();
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'getYarnNodes', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('getYarnNodes', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_getYarnNodes()
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, 'MapredService_getYarnNodes_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new MapredService_getYarnNodes_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new Exception("getYarnNodes failed: unknown result");
  }
...
class MapredService_getYarnInfo_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'MapredService_getYarnInfo_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('MapredService_getYarnInfo_args');
    $xfer += $output->writeFieldStop();
    $xfer += $output->writeStructEnd();
    return $xfer;
  }
...
class MapredService_getYarnInfo_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'MapredService_getYarnInfo_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('MapredService_getYarnInfo_result');
    if ($this->success !== null) {
      $xfer += $output->writeFieldBegin('success', TType::STRING, 0);
      $xfer += $output->writeString($this->success);
      $xfer += $output->writeFieldEnd();
...
class MapredService_getYarnNodes_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'MapredService_getYarnNodes_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('MapredService_getYarnNodes_args');
    $xfer += $output->writeFieldStop();
    $xfer += $output->writeStructEnd();
    return $xfer;
  }
...
class MapredService_getYarnNodes_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'MapredService_getYarnNodes_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('MapredService_getYarnNodes_result');
    if ($this->success !== null) {
      $xfer += $output->writeFieldBegin('success', TType::STRING, 0);
      $xfer += $output->writeString($this->success);
      $xfer += $output->writeFieldEnd();
