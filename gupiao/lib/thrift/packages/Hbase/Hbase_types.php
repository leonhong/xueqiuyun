...
class Mutation {
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['isWriteWAL'])) {
        $this->isWriteWAL = $vals['isWriteWAL'];
      }
    }
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 5:
          if ($ftype == TType::BOOL) {
            $xfer += $input->readBool($this->isWriteWAL);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->isWriteWAL !== null) {
      $xfer += $output->writeFieldBegin('isWriteWAL', TType::BOOL, 5);
      $xfer += $output->writeBool($this->isWriteWAL);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
    $xfer += $output->writeStructEnd();
...
class TScan {
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['indexExpression'])) {
        $this->indexExpression = $vals['indexExpression'];
      }
    }
  }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 7:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->indexExpression);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    ...
    if ($this->indexExpression !== null) {
      $xfer += $output->writeFieldBegin('indexExpression', TType::STRING, 7);
      $xfer += $output->writeString($this->indexExpression);
      $xfer += $output->writeFieldEnd();
    }
    $xfer += $output->writeFieldStop();
    $xfer += $output->writeStructEnd();
...
class ColumnStore {
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['columnfamily'])) {
        $this->columnfamily = $vals['columnfamily'];
      }
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::STRING) {
            $xfer += $input->readString($this->columnfamily);
          } else {
            $xfer += $input->skip($ftype);
          }
          break;
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ColumnStore');
    if ($this->table !== null) {
    ...
    if ($this->columnfamily !== null) {
      ...
      $xfer += $output->writeString($this->columnfamily);
      $xfer += $output->writeFieldEnd();
    }
...
class ColumnElement {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ColumnElement');
    if ($this->columnname !== null) {
    ...
    if ($this->digest !== null) {
      $xfer += $output->writeFieldBegin('digest', TType::STRING, 3);
      $xfer += $output->writeString($this->digest);
      $xfer += $output->writeFieldEnd();
    }
    if ($this->timestamp !== null) {
...
class KeyStore {
  ...
  public function __construct($vals=null) {
    ...
    if (is_array($vals)) {
      ...
      if (isset($vals['columnlist'])) {
        $this->columnlist = $vals['columnlist'];
      }
    }
  }
      ...
      switch ($fid)
      {
        ...
        case 4:
          if ($ftype == TType::LST) {
            ...
            {
              $elem28 = null;
              $elem28 = new ColumnElement();
              $xfer += $elem28->read($input);
              $this->columnlist []= $elem28;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('KeyStore');
    if ($this->table !== null) {
      $xfer += $output->writeFieldBegin('table', TType::STRING, 1);
      $xfer += $output->writeString($this->table);
      $xfer += $output->writeFieldEnd();
    ...
    if ($this->columnlist !== null) {
      ...
      $xfer += $output->writeFieldBegin('columnlist', TType::LST, 4);
      {
        $output->writeListBegin(TType::STRUCT, count($this->columnlist));
        {
          foreach ($this->columnlist as $iter29)
          {
...
class QstoreException extends TException {
  static $_TSPEC;
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('QstoreException');
    if ($this->type !== null) {
