    ...
    def process_item(self, item, spider):
        ...
        try:
            ...
            if len(rows)==0:
                ...
                sql="update xl_hk_caiwu set " \
                    +"yingyee='"+item["yingyee"]+"'," \
                    +" sunyie='"+item["sunyie"]+"', " \
                    +"yinglihuokuisun='"+item["yinglihuokuisun"]+"', " \
                    +"zhenfu='"+item["zhenfu"]+"',"\
                    +" feijingchangxingshouyi='"+item["feijingchangxingshouyi"]+"', " \
                    +"jibenmeiguyingli='"+item["jibenmeiguyingli"]+"', " \
                    +"tanbomeiguyinglin='"+item["tanbomeiguyinglin"]+"',"\
                    +"tebieguxi='"+item["tebieguxi"]+"', " \
                    +"guxijiezhikaishi='"+item["guxijiezhikaishi"]+"', " \
                    +"guxijiezhijieshu='"+item["guxijiezhikaishi"]+"'," \
                    +"guxiyingfuriqi='"+item["guxiyingfuriqi"]+"'  " \
                    +"where pk='"+item['code']+"-"+item['end_time']+item["type"]+"'"
                cur.execute(sql)
                self.conn.commit()
        except Exception,e:
        ...
        if not item["bank"]:
            ...
            try:
                ...
                if len(rows) == 0:
                    ...
                    sql="update xl_hk_fuzhai set " \
                        "feiliudongzichan='"+item["feiliudongzichan"]+"', " \
                        "liudongzichan='"+item["liudongzichan"]+"'," \
                        " liudongfuzai='"+item["liudongfuzai"]+"', " \
                        "jingliudongzichan='"+item["jingliudongzichan"]+"', " \
                        "feiliudongfuzai='"+item["feiliudongfuzai"]+"'," \
                        " shaoshugudongquanyi='"+item["shaoshugudongquanyi"]+"', " \
                        "jingzichan='"+item["jingzichan"]+"', " \
                        "yifaxingguben='"+item["yifaxingguben"]+"'," \
                        " chubei='"+item["chubei"]+"', " \
                        "gudongquanyi='"+item["gudongquanyi"]+"', " \
                        "wuxingzichan='"+item["wuxingzichan"]+"'," \
                        " wuyechangfangshebei='"+item["wuyechangfangshebei"]+"', " \
                        "fushugongsiquanyi='"+item["fushugongsiquanyi"]+"', " \
                        "lianyinggongsiquanyi='"+item["lianyinggongsiquanyi"]+"', " \
                        "qitatouzi='"+item["qitatouzi"]+"', " \
                        "yingshouzhangkuan='"+item["yingshouzhangkuan"]+"', " \
                        "cunhuo='"+item["cunhuo"]+"'," \
                        "xianjinjiyinhangjiecun='"+item["xianjinjiyinhangjiecun"]+"', " \
                        "yingfuzhangkuan='"+item["yingfuzhangkuan"]+"'," \
                        "yinhangdaikuan='"+item["yinhangdaikuan"]+"'," \
                        "feiliudongyinhangdaikuan='"+item["feiliudongyinhangdaikuan"]+"', " \
                        "zongzichan='"+item["zongzichan"]+"', " \
                        "zongfuzai='"+item["zongfuzai"]+"'," \
                        "gufenshumu='"+item["gufenshumu"]+"'  " \
                        "where pk='"+ item["code"] + "-" + item["baogaoriqi"] + item["type"] +"'"
                    cur.execute(sql)
                    self.conn.commit()
            except Exception, e:
                log.msg(sql)
            ...
            try:
                ...
                if len(rows) == 0:
                    ...
                    sql="update xl_hk_bank_fuzhai set " \
                        "xianjinjinduanqizijin='"+item["xianjinjinduanqizijin"]+"', " \
                        "yinghangtongyejiqitajinrongjingoucunkaun='"+item["yinghangtongyejiqitajinrongjingoucunkaun"]+"'," \
                        " maoyipiaoju='"+item["maoyipiaoju"]+"', " \
                        "xianggangyequzhengfufuzhaizhengmingshu='"+item["xianggangyequzhengfufuzhaizhengmingshu"]+"', " \
                        "jehudaikuanjiqitazhangkuang='"+item["jehudaikuanjiqitazhangkuang"]+"', " \
                        "chizhidaoqizhengquanzhaiwuzhengquangupiao='"+item["chizhidaoqizhengquanzhaiwuzhengquangupiao"]+"'," \
                        " lianyinggongsiquanyi='"+item["lianyinggongsiquanyi"]+"', " \
                        "hezigongsiquanyijiqitaquanyi='"+item["hezigongsiquanyijiqitaquanyi"]+"', " \
                        "wuxingzichan='"+item["wuxingzichan"]+"', " \
                        "gudingzichangjitouziwuye='"+item["gudingzichangjitouziwuye"]+"', " \
                        "titazichan='"+item["titazichan"]+"', " \
                        "zongzichan='"+item["zongzichan"]+"', " \
                        "xianggangzhibiliutonge='"+item["xianggangzhibiliutonge"]+"', " \
                        "yinghangjiqitajirongjigoucunkuanjijieyu='"+item["yinghangjiqitajirongjigoucunkuanjijieyu"]+"'," \
                        " kehucunkuan='"+item["kehucunkuan"]+"', " \
                        "yifaxingzhaiwuzhengquan='"+item["yifaxingzhaiwuzhengquan"]+"', " \
                        "qitafuzhai='"+item["qitafuzhai"]+"', " \
                        "zongfuzhai='"+item["zongfuzhai"]+"', " \
                        "jiruziben='"+item["jiruziben"]+"', " \
                        "guben='"+item["guben"]+"'," \
                        " chubei='"+item["chubei"]+"', " \
                        "gudongquanyi='"+item["gudongquanyi"]+"', " \
                        "shaoshugudongquanyi='"+item["shaoshugudongquanyi"]+"', " \
                        "zibenlaiyuanheji='"+item["zibenlaiyuanheji"]+"', " \
                        "fuzhaijizibenlaiyuanheji='"+item["fuzhaijizibenlaiyuanheji"]+"', " \
                        "gufenshumu='"+item["gufenshumu"]+"', " \
                        "chiyoudecunkuanzheng='"+item["chiyoudecunkuanzheng"]+"', " \
                        "chizuomaimaiyongtuzhengquan='"+item["chizuomaimaiyongtuzhengquan"]+"'," \
                        " yifaxingcunkuanzheng='"+item["yifaxingcunkuanzheng"]+"' " \
                        "where  pk='" + item["code"] + "-" + item["baogaoriqi"] + item["type"] + "'"
                    cur.execute(sql)
                    self.conn.commit()
            except Exception, e:
    ...
    def process_item(self, item, spider):
        ...
        try:
            ...
            if len(rows) == 0:
                ...
                sql="update xl_hk_xianjin set " \
                    "jingyingliuru='"+item["jingyingliuru"]+"', " \
                    "touziliuru='"+item["touziliuru"]+"'," \
                    "rongziliuru='"+item["rongziliuru"]+"', " \
                    "xianjinjidengjiawuzengjia='"+item["xianjinjidengjiawuzengjia"]+"', " \
                    "nianchuxianji='"+item["nianchuxianji"]+"'," \
                    "nianzhongxianjin='"+item["nianzhongxianjin"]+"', " \
                    "waihuiyingxiang='"+item["waihuiyingxiang"]+"', " \
                    "gouzhigudingzichan='"+item["gouzhigudingzichan"]+"'   " \
                    "where  pk='"+item['code']+"-"+item['baogaoriqi']+ item["type"] +"'"
                cur.execute(sql)
                self.conn.commit()
        except Exception, e:
        ...
        if not item["bank"]:
            ...
            try:
                ...
                if len(rows) == 0:
                    ...
                    sql="update xl_hk_sunyi set " \
                        "yingyee='"+item["yingyee"]+"', " \
                        "chusuiqianyingli='"+item["chusuiqianyingli"]+"'," \
                        " suixiang='"+item["suixiang"]+"', " \
                        "chusuihouyingli='"+item["chusuihouyingli"]+"', " \
                        "shaoshugudongquanyi='"+item["shaoshugudongquanyi"]+"'," \
                        "gudongyingzhanyingli='"+item["gudongyingzhanyingli"]+"'," \
                        "guxi='"+item["guxi"]+"'," \
                        "chusuiguxihouyingli='"+item["chusuiguxihouyingli"]+"', " \
                        "meiguyingli='"+item["meiguyingli"]+"', " \
                        "tanboyingli='"+item["tanboyingli"]+"'," \
                        "meiguguxi='"+item["meiguguxi"]+"'," \
                        " xiaoshouchengben='"+item["xiaoshouchengben"]+"', " \
                        "zhejiu='"+item["zhejiu"]+"', " \
                        "xiaoshoujifeixiaofeiyong='"+item["xiaoshoujifeixiaofeiyong"]+"', " \
                        "yibanjixingzhengfeiyong='"+item["yibanjixingzhengfeiyong"]+"', " \
                        "lixifeiyong='"+item["lixifeiyong"]+"'," \
                        "maoli='"+item["maoli"]+"'," \
                        "jingyingyingli='"+item["jingyingyingli"]+"', " \
                        "yingzhanliangyinggongsiyingli='"+item["yingzhanliangyinggongsiyingli"]+"'" \
                        "  where pk='"+item['code']+"-"+item['baogaoriqi']+ item["type"] +"'"
            ...
            try:
                ...
                if len(rows) == 0:
                    ...
                    sql="update xl_hk_bank_sunyi set " \
                        "lixishouru='"+item["lixishouru"]+"', " \
                        "lixizhichu='"+item["lixizhichu"]+"'," \
                        "jinglixishouru='"+item["jinglixishouru"]+"', " \
                        "qitajingyingshouru='"+item["qitajingyingshouru"]+"'," \
                        "jingyingshouru='"+item["jingyingshouru"]+"', " \
                        "jingyingzhichu='"+item["jingyingzhichu"]+"', " \
                        "zongzhunbei='"+item["zongzhunbei"]+"'," \
                        "qitayingli='"+item["qitayingli"]+"', " \
                        "shuiqianyingli='"+item["shuiqianyingli"]+"', " \
                        "shuixiang='"+item["shuixiang"]+"', " \
                        "chushuihouyingli='"+item["chushuihouyingli"]+"', " \
                        "shaoshugudongquanyi='"+item["shaoshugudongquanyi"]+"', " \
                        "gudongyingzhanyingli='"+item["gudongyingzhanyingli"]+"'," \
                        "guxi='"+item["guxi"]+"', " \
                        "chushuiguxihouyingli='"+item["chushuiguxihouyingli"]+"', " \
                        "jibenmeiguyingli='"+item["jibenmeiguyingli"]+"'," \
                        "tanbomeiguyingli='"+item["tanbomeiguyingli"]+"'  " \
                        "where pk='" + item['code'] + "-" + item['baogaoriqi'] + item["type"] + "'"
                    cur.execute(sql)
                    self.conn.commit()
            except Exception, e:
...
class hk_value(object):
    ...
    def process_item(self, item, spider):
        log.msg("process_item 0 =" + item['code'])
        cur = self.conn.cursor()
        ...
        try:
            ...
            if len(rows) == 0:
                if item['code'] == '00321':
                    log.msg("len(rows) == 0 code=" + item['code'])
        ...
        try:
            ...
            if len(rows)==0:
                sql="insert into history_hk_fuzhai (pk, code, date, " \
                    "gudingzichan, liudongfuzhai, cunkuan," \
