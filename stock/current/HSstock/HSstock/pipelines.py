    ...
    def process_item(self, item, spider):
        ...
        if not item["bank"]:
            ...
            try:
                ...
                log.msg("xxx=" + str(e), _level=logging.ERROR)
        else:
            ...
            try:
                ...
                log.msg("yyy=" + str(e), _level=logging.ERROR)
    ...
    def process_item(self, item, spider):
        ...
        if not item["bank"]:
            ...
            try:
                ...
                log.msg("YYYYY="+str(e), _level=logging.DEBUG)
            ...
            try:
                ...
                #log.msg(e, _level=logging.DEBUG)
                
                log.msg("xxx="+str(e), _level=logging.DEBUG)
