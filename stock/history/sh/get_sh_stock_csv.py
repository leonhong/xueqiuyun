        ...
        for i in range(0, len(lines)):
            ...
            if i > 0:
                ...
                if len(contexts) > 1:
                    ...
                    sql = "select MAX(date) from sh_storck_historical_transaction where stock_code = '" + stockCode + "'"
...
if __name__ == '__main__':
    (conn_new, cur_new) = getConnAndCursor()
    stock_code_list = cur_new.execute("select stock_code from sh_stock_list")
